...
router.get('/dashboard/concentration-settings', concentrationSettings.getPage);
router.get('/bidding-settings/concentration-settings', concentrationSettings.getPage);
